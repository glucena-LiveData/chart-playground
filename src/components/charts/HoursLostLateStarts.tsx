...
const chartConfig = {
	...
	y_axis: {
		...
		formatter: (value: number) => `Hours Lost to First Case Late Starts: ${(value)}`,
...
export default function HoursLostLateStarts() {
	return (
		<AreaGraph title="Hours Lost to First Case Late Starts" data={chartData} chartConfig={chartConfig} />	
	)
}
