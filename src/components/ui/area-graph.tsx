import { AreaChart, Area, XAxis, YAxis, Text, Tooltip } from "recharts"
import {
  Card,
  CardContent,
  CardDescription,
					...
					<AreaChart accessibilityLayer data={data}>
						<defs>
							<linearGradient id={gradientId} x1="0" y1="0" x2="0" y2="1">
								<stop offset="0%" stopColor={yAxisConfig.color ? yAxisConfig.color : "#7B71FA"} stopOpacity={0.3} />
								<stop offset="100%" stopColor={yAxisConfig.color ? yAxisConfig.color : "#7B71FA"} stopOpacity={0.05} />
							</linearGradient>
						</defs>
						<XAxis
							...
							tickMargin={10}
							axisLine={false}
							tickFormatter={xAxisConfig.formatter? xAxisConfig.formatter : (value) => value}
						...
						<ChartTooltip 
							...
							formatter={yAxisConfig.formatter? yAxisConfig.formatter : (value) => value}
						/>
						<YAxis
							type="number"
							tickLine={false}
							axisLine={false}
							tickFormatter={yAxisConfig.tickFormatter? yAxisConfig.tickFormatter : (value) => value}
